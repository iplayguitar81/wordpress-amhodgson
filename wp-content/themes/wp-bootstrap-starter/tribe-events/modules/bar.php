...
<div id="tribe-events-bar georgia">
				...
				<div id="tribe-bar-filters" class="tribe-bar-filters" aria-hidden="true">
					<div class="tribe-bar-filters-inner tribe-clearfix">
						...
						<?php foreach ( $filters as $filter ) : ?>
							<div class="<?php echo esc_attr( $filter['name'] ) ?>-filter georgia">
								<label class="label-<?php echo esc_attr( $filter['name'] ) ?> georgia" for="<?php echo esc_attr( $filter['name'] ) ?>"><?php echo $filter['caption'] ?></label>
								<?php echo $filter['html'] ?>
							</div>
						<?php endforeach; ?>
						<div class="tribe-bar-submit">
							<input
								class="tribe-events-button tribe-no-param georgia"
								type="submit"
								name="submit-bar"
		...
		<?php if ( count( $views ) > 1 ) : ?>
			<div id="tribe-bar-views" class="tribe-bar-views">
				<div class="tribe-bar-views-inner tribe-clearfix">
					...
					<label id="tribe-bar-views-label georgia" aria-label="<?php printf( esc_html__( 'View %s As', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?>">
					...
					>
						...
						foreach ( $views as $view ) {
							printf(
								'<option value="%1$s" class="georgia" data-view="%2$s"%3$s>%4$s</option>',
								esc_attr( $view['url'] ),
